    ...
    <div className={cx("wrapper")}>
      <div className={cx("box-list")}>
        <div className={cx("box-item")}>
          <div className={cx("box-item__icon")}>
            <svg
              width="44"
              height="55"
              viewBox="0 0 44 55"
          ...
          <div className={cx("box-item__title")}>Địa chỉ</div>
          <div className={cx("box-item__msg")}>
        ...
        <div className={cx("box-item")}>
          ...
          <div className={cx("box-item__title")}>Tổng đài hỗ trợ</div>
          <div className={cx("box-item__msg")}>hellocafein@gmail.com</div>
        </div>
        <div className={cx("box-item")}>
          <div className={cx("box-item__icon")}>
            <svg
            ...
            >
              <path
                d="M38.4482 9.05962V16.9539L43.8375 12.8161L38.4482 9.05962Z"
                fill="#339538"
              ></path>
              <path
                d="M6.873 9.05962L1.4837 12.8161L6.873 16.9539V9.05962Z"
                fill="#339538"
              ></path>
              <path
              ...
              ></path>
              <path
                d="M0.884613 14.3405V37.2055L16.6722 26.5353L0.884613 14.3405Z"
                fill="#339538"
              ></path>
              <path
                d="M28.649 26.5353L44.4366 37.2055V14.3405L28.649 26.5353Z"
                fill="#339538"
              ></path>
              <path
          ...
          <div className={cx("box-item__title")}>Email</div>
          <div className={cx("box-item__msg")}>1900 6750</div>
        </div>
      </div>
      <div className={cx("map")}>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.661143431239!2d108.24781051498265!3d15.979062646092036!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3142108f7b7e856f%3A0xc0d2b2c4207e4a21!2zMTIzIE5ndXnhu4VuIE1pbmggQ2jDonUsIEhvw6AgSOG6o2ksIE5nxakgSMOgbmggU8ahbiwgxJDDoCBO4bq1bmcgNTUwMDAwLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1665114587387!5m2!1svi!2s"
          allowfullscreen=""
          loading="lazy"
      ...
      <div className={cx('main')}>
          ...
          <p className={cx('main__subtitle')}>Bạn hãy điền nội dung tin nhắn vào form dưới đây. Chúng tôi sẽ trả lời bạn ngay sau khi nhận được tin nhắn.</p>
          <form className={cx('form')}>
            <div className={cx('form-user')}>
              <div className={cx('form-group', 'form-group__name')}>
                <input placeholder="Họ và tên:"/>
              </div>
              <div className={cx('form-group','form-group__sdt')}>
